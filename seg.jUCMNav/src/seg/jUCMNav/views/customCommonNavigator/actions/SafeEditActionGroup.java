...
/**
 * The platform's internal navigator EditActionGroup, wired to the safe
 * {@link SafePasteAction} / {@link SafeCopyAction} clones. Everything else -
 * including the delete action and the {@link TextActionHandler} integration
 * that keeps copy/paste working inside in-view text fields - behaves
 * exactly as the platform version.
 *
 * @author skuly
 */
public class SafeEditActionGroup extends ActionGroup {
	...
	public SafeEditActionGroup(Shell aShell) {
		shell = aShell;
		makeActions();
	}
